...
function tableCard(props) {
    let color = "#34CAA5"
    if (props.status === "refund") {
        color ="#ED544E"
    }
    return(
        <>
             <tr className="dark:border-y-[#122026] dark:hover:bg-[#122026] border-y text-base">
